    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('channel', models.ForeignKey(related_name='channel_amazonorders', default=1, to='integration.Channel')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('name', models.FileField(max_length=200, upload_to=b'/Users/vishnu/PycharmProjects/esales_api/esales_api/media/csv/%Y-%m-%d', validators=[inventory.models.validate_file_extension])),
                ('status', models.SmallIntegerField(default=0)),
                ('created_on', models.DateTimeField(auto_now_add=True)),
                ('updated_on', models.DateTimeField(auto_now=True, auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ucodetype', models.CharField(blank=True, max_length=20, choices=[(b'ISBN', b'ISBN'), (b'UPC', b'UPC'), (b'EAN', b'EAN')])),
                ...
                ('sold_quantity', models.IntegerField(default=0, blank=True)),
                ('pending_quantity', models.IntegerField(default=0, blank=True)),
                ('image_url', models.CharField(default=b'', max_length=100, blank=True)),
                ('shipping_fee', models.CharField(default=b'', max_length=100, blank=True)),
                ('will_ship_internationally', models.CharField(default=b'', max_length=100, blank=True)),
                ('expedited_shipping', models.CharField(default=b'', max_length=100, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('min_stock_quantity', models.IntegerField(default=0, null=True, blank=True)),
                ('sold_quantity', models.IntegerField(default=0, blank=True)),
                ('pending_quantity', models.IntegerField(default=0, blank=True)),
                ('image_url', models.CharField(default=b'', max_length=100, blank=True)),
                ('shipping_fee', models.CharField(default=b'', max_length=100, blank=True)),
                ...
                ('product_type', models.CharField(default=1, max_length=5, blank=True, choices=[(b'1', b'Normal'), (b'2', b'Bundle'), (b'3', b'Variation Parent')])),
                ('created_on', models.DateTimeField(auto_now_add=True)),
                ('updated_on', models.DateTimeField(auto_now=True, auto_now_add=True)),
                ('category', models.ForeignKey(blank=True, to='inventory.Category', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('orderitemid', models.CharField(max_length=40, null=True, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('name', models.CharField(unique=True, max_length=105)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(related_name='productwarehousebin', blank=True, to='inventory.Product', null=True)),
