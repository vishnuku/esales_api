...
class Inventory(models.Model):
    ...
    weight1_unit = models.CharField(blank=True, null=True, max_length=50)
    weight2 = models.IntegerField(blank=True, null=True)
    weight2_unit = models.CharField(blank=True, null=True, max_length=50)
    dimension_length = models.IntegerField(blank=True, null=True)
    dimension_height = models.IntegerField(blank=True, null=True)
    dimension_width = models.IntegerField(blank=True, null=True)
    dimension_unit = models.CharField(blank=True, null=True, max_length=50)
    created_on = models.DateTimeField(auto_now_add=True)
    updated_on = models.DateTimeField(auto_now=True, auto_now_add=True)
